...
//    }
  ...
  protected void initDemoGroups() {
    ///String[] assignmentGroups = new String[] {"management", "sales", "marketing", "engineering"};
	    String[] assignmentGroups = new String[] {"研发部", "研发经理", "研发总监", "人事","总经理"};
...
//            null);
    ...
    createUser("liusy", "", "刘盛业", "liusy", "liusy@activiti.org", "", Arrays.asList("研发部"),null);
    createUser("zhangs", "", "张三", "zhangs", "zhangs@activiti.org","",Arrays.asList("研发经理"), null);
    createUser("lis", "", "李四", "lis", "lis@activiti.org","", Arrays.asList("研发总监"), null);
    createUser("wangw", "", "王五", "lis", "wangw@activiti.org","", Arrays.asList("人事"),null);
    createUser("zhaol", "", "赵六", "zhaol", "zhaol@activiti.org","", Arrays.asList("总经理"),null);
    createUser("guanliy", "", "管理员", "guanliy", "guanliy@activiti.org", "",Arrays.asList("admin"),null);
