...
public final class CatalogItem_005fgrid_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String CONTEXT_PATH = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.print(CONTEXT_PATH);
      out.write("\";\r\n");
      out.write("\t\tvar hyperlink = \"../cms/catalog.do\";\r\n");
      out.write("\t\tvar fulllink = contextpath + \"cms/catalog.do\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction goAdd()  {\r\n");
      out.write("   \t\t\teditMode=\"ADD\";\r\n");
      out.write("   \t\t\tparent.operate='';\r\n");
      out.write("   \t\t\tvar url_link=fulllink+'?action=addCatalogItem&catalogId='+getElement('query.parameters.catalogId').value;\r\n");
      out.write("   \t\t\tparent.openWindow(\"添加\",url_link,1070,550);\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tvar url_link=fulllink+'?action=editCatalogItem&ids='+id;\r\n");
      out.write("   \t\t\tparent.openWindow(\"修改\",url_link,1070,550);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction goDel() {\r\n");
      out.write("\t\t\tparent.operate='';\r\n");
      out.write("\t\t\tvar ids = findMultiSelected(\"删除\",mygrid);\r\n");
      out.write("\t\t\tif (ids == \"\") return;\r\n");
      out.write("\t\t\t\tvar res = confirm(\"是否真的要删除?\");\r\n");
      out.write("\t\t\tif(res == true) {\r\n");
      out.write("\t\t\tvar data = ajaxSubmit(fulllink + \"?action=deleteCatalogItem&ids=\"+ids,null);\r\n");
      out.write("\t\t\tif(data.status=='success')\r\n");
      out.write("\t\t\t\trenew(null);\r\n");
      out.write("\t\t\telse\t\r\n");
      ...
      out.write("\t\t\tgosearch(\"catalogItemList\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("   gridbox.style.height=(window.document.body.offsetHeight-30)+\"px\";\r\n");
      ...
      out.write("\tmygrid.setHeader(\" ,主题,创始人,创建时间,类型,状态,备注\",null,headAlign);\r\n");
      out.write("\tmygrid.setInitWidthsP(\"3,35,20,10,12,12,8,40\");\r\n");
      out.write("\tmygrid.setColAlign(\"center,center,center,center,center,center,center\");\r\n");
      out.write("\tmygrid.setColTypes(\"ch,ro,ro,ro,ro,ro,ro\");\r\n");
      out.write("\tmygrid.setColSorting(\"na,str,str,date,str,str,str\");\r\n");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(75,18) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f0.setValue("errorMessage");
    // /cms/admin/CatalogItem_grid.jsp(75,18) name = escape type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(87,0) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setAction("sysCode");
    // /cms/admin/CatalogItem_grid.jsp(87,0) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setId("codeForm");
    // /cms/admin/CatalogItem_grid.jsp(87,0) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setMethod("post");
    // /cms/admin/CatalogItem_grid.jsp(87,0) name = namespace type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${query.parameters.catalogId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\"/> \r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_s_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(88,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f0.setName("query.parameters.action1");
    // /cms/admin/CatalogItem_grid.jsp(88,4) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(89,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f1.setName("query.parameters.catalogId");
  ...
  private boolean _jspx_meth_s_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(91,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(92,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(93,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(94,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(95,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  gl:button
    com.liusy.core.web.tag.ButtonTag _jspx_th_gl_005fbutton_005f0 = (com.liusy.core.web.tag.ButtonTag) _005fjspx_005ftagPool_005fgl_005fbutton_0026_005fstyleClass_005fonClick_005ficon.get(com.liusy.core.web.tag.ButtonTag.class);
    ...
    // /cms/admin/CatalogItem_grid.jsp(99,8) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f0.setStyleClass("sbuBtnStyle");
    // /cms/admin/CatalogItem_grid.jsp(99,8) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f0.setIcon("addIcon");
    // /cms/admin/CatalogItem_grid.jsp(99,8) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  gl:button
    com.liusy.core.web.tag.ButtonTag _jspx_th_gl_005fbutton_005f1 = (com.liusy.core.web.tag.ButtonTag) _005fjspx_005ftagPool_005fgl_005fbutton_0026_005fstyleClass_005fonClick_005fid_005ficon.get(com.liusy.core.web.tag.ButtonTag.class);
    ...
    // /cms/admin/CatalogItem_grid.jsp(100,8) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setStyleClass("sbuBtnStyle");
    // /cms/admin/CatalogItem_grid.jsp(100,8) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setId("editUser");
    // /cms/admin/CatalogItem_grid.jsp(100,8) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setIcon("subIcon");
    // /cms/admin/CatalogItem_grid.jsp(100,8) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cms/admin/CatalogItem_grid.jsp(101,8) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f2.setStyleClass("sbuBtnStyle");
    // /cms/admin/CatalogItem_grid.jsp(101,8) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f2.setIcon("delIcon");
    // /cms/admin/CatalogItem_grid.jsp(101,8) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
