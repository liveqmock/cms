...
CREATE TABLE `cms_catalog` (
  ...
  `parent_id` int(11) DEFAULT NULL COMMENT '父亲',
  `remark` varchar(50) DEFAULT NULL COMMENT '说明',
  `sort` int(11) DEFAULT NULL COMMENT '顺序',
  `type` varchar(30) DEFAULT NULL COMMENT 'subject标题、img:图片、ueditor富文本',
  PRIMARY KEY (`id`)
...
INSERT INTO `cms_catalog` VALUES (1,'CMS目录',NULL,'root',NULL,NULL),(2,'2级目录',1,'22',NULL,NULL),(3,'3级目录',2,NULL,NULL,NULL),(5,'223级目录',1,NULL,NULL,NULL),(6,'333级目录',5,NULL,NULL,NULL),(11,'33',1,'d',2,'subject, img'),(14,'77',11,'aa',33,'subject, img, ueditor'),(16,'aa',1,'ff',3,'subject, img, ueditor');
/*!40000 ALTER TABLE `cms_catalog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cms_catalog_item`
--

DROP TABLE IF EXISTS `cms_catalog_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cms_catalog_item` (
...
--
-- Dumping data for table `cms_catalog_item`
--

LOCK TABLES `cms_catalog_item` WRITE;
/*!40000 ALTER TABLE `cms_catalog_item` DISABLE KEYS */;
INSERT INTO `cms_catalog_item` VALUES (1,5,'aaaaaaaaaaa',NULL,'<h1 style=\"font-size: 32px; font-weight: bold; border-bottom: 2px solid rgb(204, 204, 204); padding: 0px 4px 0px 0px; text-align: center; margin: 0px 0px 20px;\" label=\"标题居中\">关于测试的数据</h1><p><br/></p><p>1、应急调配库存信息业务统计需求分析<br/>2、应急匹配库存数量减少，应该以发送物流为准修改<br/>3、与语音厂家（广东省电力通信有限公司）的技术交流会<br/>4、仓储配送部要求实现的有效框架协议物资的业务功能分析<br/></p>','admin','2014-06-18 00:00:00',NULL,NULL,'bbbb',NULL,1,1),(2,5,'1222222222','1403146333444/.jpg','<h1><span class=\"link_title\"><a href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333\"> &nbsp; &nbsp; &nbsp; &nbsp;html加载图片 &nbsp; &nbsp; &nbsp; &nbsp; </a></span> &nbsp; &nbsp;</h1><p><span class=\"link_categories\"> &nbsp; &nbsp; &nbsp; &nbsp;分类： &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"http://blog.csdn.net/yueqinglkong/article/category/1871643\">html</a> &nbsp; &nbsp; &nbsp; &nbsp; </span> &nbsp; &nbsp; <span class=\"link_postdate\">2014-01-22 21:28</span> &nbsp; &nbsp; <span title=\"阅读次数\" class=\"link_view\">141人阅读</span> &nbsp; &nbsp; <span title=\"评论次数\" class=\"link_comments\"><a href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#comments\">评论</a>(0)</span> &nbsp; &nbsp; <span class=\"link_collect\"><a title=\"收藏\">收藏</a></span> &nbsp; &nbsp; <span class=\"link_report\"><a title=\"举报\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#report\">举报</a></span> &nbsp; &nbsp;</p><p><a href=\"http://www.csdn.net/tag/html\" target=\"_blank\">html</a></p><p>加载网络图片，直接贴上网络图片的地址就行了：</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;http://tp1.sinaimg.cn/3079357692/180/40011325854/1&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;&nbsp;</p></li></ol><pre class=\"html\" style=\"display: none;\" name=\"code\">&lt;img&nbsp;src=&quot;http://tp1.sinaimg.cn/3079357692/180/40011325854/1&quot;&nbsp;width=&quot;100&quot;&nbsp;height=&quot;100&quot;&gt;&lt;/img&gt;</pre><p><br/>加载本地图片，“file://”+文件路径</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;file://D:/图片/火影/5c1133db51da453dd1164e39.jpg&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;&nbsp;</p></li></ol><pre class=\"html\" style=\"display: none;\" name=\"code\">&lt;img&nbsp;src=&quot;file://D:/图片/火影/5c1133db51da453dd1164e39.jpg&quot;&nbsp;width=&quot;100&quot;&nbsp;height=&quot;100&quot;&gt;&lt;/img&gt;</pre><p><br/>如果，与网页属于同一文件夹中：</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;./8d28e992jw1e6qwgc9z4oj20c80ga3zo.jpg&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;</p></li><li><p><br/></p></li></ol><p style=\"line-height: 16px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img style=\"vertical-align: middle; margin-right: 2px;\" src=\"http://localhost:8080/Web//cms/ueditor/dialogs/attachment/fileTypeImages/icon_rar.gif\"/><a style=\"font-size:12px; color:#0066cc;\" href=\"D:/Workspaces/Web/web/ueditor/jsp/upload/file/20140619/1403164253392081634.zip\" title=\"1403164253392081634.zip\">附件.zip</a></p><p><br/></p>','admin','2014-06-19 00:00:00','admin','2014-06-19 00:00:00','bbbb',NULL,1,1),(3,5,'cccccc','1403147610754/.jpg','','admin','2014-06-19 00:00:00',NULL,NULL,'ccc',NULL,1,1),(4,5,'dddddd','1403148125648/.jpg','aa','admin','2014-06-19 00:00:00',NULL,NULL,'bbb',NULL,1,1),(5,5,'eeee','1403148212982/.jpg','bb','admin','2014-06-19 00:00:00',NULL,NULL,'bb',NULL,1,1),(6,5,'fff','1403148510301/.jpg','','admin','2014-06-19 00:00:00',NULL,NULL,'ccc',NULL,1,1),(7,5,'gggggg','1403148622028/.jpg','','admin','2014-06-19 00:00:00',NULL,NULL,'vvv',NULL,1,1),(8,5,'vvvvv',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'vv',NULL,1,1),(9,5,'llll',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'lll',NULL,1,1),(10,5,'OOO',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'O',NULL,1,1),(11,5,'ttt',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(12,5,'kkk',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(13,5,'jjj',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(14,5,'jjjj',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(15,5,'uuu',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(16,5,'ppppp',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(17,5,'hhhh',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(18,5,'rrrr',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(19,5,'nnnnn',NULL,'',NULL,'2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(20,5,'qqqqqqq',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(22,5,'xxxxxxxx',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(23,5,'uuuu',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(25,5,'4444444',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(26,5,'55555',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(27,5,'9999',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(28,5,'33333',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(29,6,'刘盛业','1403162655504/.jpg','刘盛业','admin','2014-06-19 00:00:00',NULL,NULL,'刘盛业',NULL,1,1),(30,6,'1111',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'111',NULL,1,1),(31,6,'ggggggg',NULL,'','admin','2014-06-19 00:00:00',NULL,NULL,'',NULL,1,1),(32,5,'bb22222222222','1403164260035/.jpg','<h1><span class=\"link_title\"><a href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333\"> &nbsp; &nbsp; &nbsp; &nbsp;html加载图片 &nbsp; &nbsp; &nbsp; &nbsp; </a></span> &nbsp; &nbsp;</h1><p><span class=\"link_categories\"> &nbsp; &nbsp; &nbsp; &nbsp;分类： &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"http://blog.csdn.net/yueqinglkong/article/category/1871643\">html</a> &nbsp; &nbsp; &nbsp; &nbsp; </span> &nbsp; &nbsp; <span class=\"link_postdate\">2014-01-22 21:28</span> &nbsp; &nbsp; <span title=\"阅读次数\" class=\"link_view\">141人阅读</span> &nbsp; &nbsp; <span title=\"评论次数\" class=\"link_comments\"><a href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#comments\">评论</a>(0)</span> &nbsp; &nbsp; <span class=\"link_collect\"><a title=\"收藏\">收藏</a></span> &nbsp; &nbsp; <span class=\"link_report\"><a title=\"举报\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#report\">举报</a></span> &nbsp; &nbsp;</p><p><a href=\"http://www.csdn.net/tag/html\" target=\"_blank\">html</a></p><p>加载网络图片，直接贴上网络图片的地址就行了：</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;http://tp1.sinaimg.cn/3079357692/180/40011325854/1&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;&nbsp;</p></li></ol><pre class=\"html\" style=\"display: none;\" name=\"code\">&lt;img&nbsp;src=&quot;http://tp1.sinaimg.cn/3079357692/180/40011325854/1&quot;&nbsp;width=&quot;100&quot;&nbsp;height=&quot;100&quot;&gt;&lt;/img&gt;</pre><p><br/>加载本地图片，“file://”+文件路径</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;file://D:/图片/火影/5c1133db51da453dd1164e39.jpg&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;&nbsp;</p></li></ol><pre class=\"html\" style=\"display: none;\" name=\"code\">&lt;img&nbsp;src=&quot;file://D:/图片/火影/5c1133db51da453dd1164e39.jpg&quot;&nbsp;width=&quot;100&quot;&nbsp;height=&quot;100&quot;&gt;&lt;/img&gt;</pre><p><br/>如果，与网页属于同一文件夹中：</p><p><strong>[html]</strong> <a title=\"view plain\" class=\"ViewSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">view plain</a><a title=\"copy\" class=\"CopyToClipboard\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">copy</a><a title=\"print\" class=\"PrintSource\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">print</a><a title=\"?\" class=\"About\" href=\"http://blog.csdn.net/yueqinglkong/article/details/18674333#\">?</a><a title=\"在CODE上查看代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354\" target=\"_blank\"><img style=\"left: 2px; top: 1px; position: relative;\" alt=\"在CODE上查看代码片\" src height=\"12\" width=\"12\"/></a><a title=\"派生到我的代码片\" style=\"text-indent: 0px;\" href=\"https://code.csdn.net/snippets/167354/fork\" target=\"_blank\"><img style=\"left: 2px; top: 2px; position: relative;\" alt=\"派生到我的代码片\" src height=\"12\" width=\"12\"/></a></p><ol class=\"dp-xml list-paddingleft-2\"><li><p><span class=\"tag\">&lt;</span><span class=\"tag-name\">img</span>&nbsp;<span class=\"attribute\">src</span>=<span class=\"attribute-value\">&quot;./8d28e992jw1e6qwgc9z4oj20c80ga3zo.jpg&quot;</span>&nbsp;<span class=\"attribute\">width</span>=<span class=\"attribute-value\">&quot;100&quot;</span>&nbsp;<span class=\"attribute\">height</span>=<span class=\"attribute-value\">&quot;100&quot;</span><span class=\"tag\">&gt;</span><span class=\"tag\">&lt;/</span><span class=\"tag-name\">img</span><span class=\"tag\">&gt;</span>&nbsp;</p></li></ol><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><p style=\"line-height: 16px;\"><img style=\"vertical-align: middle; margin-right: 2px;\" src=\"http://localhost:8080/Web//cms/ueditor/dialogs/attachment/fileTypeImages/icon_rar.gif\"/><a style=\"font-size:12px; color:#0066cc;\" href=\"/ueditor/jsp/upload/file/20140619/1403164253392081634.zip\" title=\"ueditor1_4_3-utf8-jsp.zip\">ueditor1_4_3-utf8-jsp.zip</a></p><p><br/></p>','admin','2014-06-19 00:00:00',NULL,NULL,'2222222222222222222222',NULL,1,1);
/*!40000 ALTER TABLE `cms_catalog_item` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_code` (
  ...
  `REMARK` longtext,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4311 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-06-20 15:17:30
